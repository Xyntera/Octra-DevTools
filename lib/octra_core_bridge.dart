...
abstract class OctraCoreBridge {
  ...
  Future<Map<String, dynamic>> executePrivacyOperation(
    Map<String, dynamic> payload,
  );
  Future<Map<String, dynamic>> recommendFee(
...
class FfiOctraCoreBridge implements OctraCoreBridge {
  ...
  FfiOctraCoreBridge._(this._lib) {
    _version = _lib.lookupFunction<_StringFnNative, _StringFnDart>(
      'octra_core_version',
    );
    _health = _lib.lookupFunction<_StringFnNative, _StringFnDart>(
      'octra_core_health',
    );
    ...
    _executePrivacyOperation = _lib
        .lookupFunction<_OneStringFnNative, _OneStringFnDart>(
  ...
  Future<List<dynamic>> historySnapshot(
    ...
    try {
      ...
      return result['transactions'] is List
